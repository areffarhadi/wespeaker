...
* **Git / backup:** See [`REPO_LAYOUT.md`](REPO_LAYOUT.md) for what must be pushed outside this folder (`wespeaker/diar/`, parent `tools/`). Logs, `exp/`, `data/`, and `poly-sim/` are gitignored.
